...
\frac{\overbrace{53}^k \cdot y}{323} \ 
\uncover<2->{= \frac{k \cdot c \cdot y}{\underbrace{323 \cdot c}_{2^n}}} 
\uncover<6->{\alert{\approx \frac{21 \cdot y}{128}}} \\
\uncover<3->{n = 7 \Rightarrow c = \frac{128}{323}} 
\uncover<4->{\Rightarrow k \cdot c = \frac{128 \cdot 53}{323} = 21,003096} \\
\uncover<5->{Fehler = \frac{21 - 21,003096}{21,003096} = 0,0147 \%} 
\end{IEEEeqnarray*}
\end{frame}
